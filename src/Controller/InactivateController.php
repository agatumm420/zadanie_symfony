...
use App\UserDto;
use App\InactiveResponse;
use App\RereshBody;
final class InactivateController
{
    /**
     * @var RenderOpenApi
     */
    ...
    /**
     * Inactivates user's token.
     *
     * When logout happens returns code and message.
     *
     ...
     *     @OA\JsonContent(
     *        type="array",
     *        @OA\Items(ref=@Model(type=InactiveResponse::class, ))
     *     )
     * )
